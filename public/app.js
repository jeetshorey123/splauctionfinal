...
const ALL_PLAYERS = [
  ...
  {id:9,player_id:'P009',player_name:'Adi rane'},{id:10,player_id:'P010',player_name:'Pratyush prakash kadam'},
  {id:11,player_id:'P011',player_name:'Jatin'},{id:12,player_id:'P012',player_name:'Nilesh Vishwakarma'},
  {id:13,player_id:'P013',player_name:'Harish Jetli'},{id:14,player_id:'P014',player_name:'Nikunj toshniwal'},
  {id:15,player_id:'P015',player_name:'Parth Doshi'},{id:16,player_id:'P016',player_name:'Mihir Makwana'},
  {id:17,player_id:'P017',player_name:'Bharat miatry'},{id:18,player_id:'P018',player_name:'Kishore'},
  {id:19,player_id:'P019',player_name:'Aaryan mistry'},{id:20,player_id:'P020',player_name:'Naveen Porwal'},
  {id:21,player_id:'P021',player_name:'Prateek Gond'},{id:22,player_id:'P022',player_name:'Hait Dama'},
  {id:23,player_id:'P023',player_name:'Jay patel'},{id:24,player_id:'P024',player_name:'Monish Shastri'},
  {id:25,player_id:'P025',player_name:'Pramod Rane'},{id:26,player_id:'P026',player_name:'SUNIL BOHRA'},
  {id:27,player_id:'P027',player_name:'Viraj singh'},{id:28,player_id:'P028',player_name:'Vimarsh'},
  {id:29,player_id:'P029',player_name:'Sidharth singh'},{id:30,player_id:'P030',player_name:'Tejas Suthar'},
  {id:31,player_id:'P031',player_name:'Vikas mishra'},{id:32,player_id:'P032',player_name:'Krishna'},
  {id:33,player_id:'P033',player_name:'Sadashiv devadiga'},{id:34,player_id:'P034',player_name:'Rakesh Singh'},
  {id:35,player_id:'P035',player_name:'Shailesh Singh'},{id:36,player_id:'P036',player_name:'Aryan Singh(602)'},
  {id:37,player_id:'P037',player_name:'jeet shorey'},{id:38,player_id:'P038',player_name:'Kush Dama'},
  {id:39,player_id:'P039',player_name:'Veer dama'},{id:40,player_id:'P040',player_name:'Ajay seth'},
  {id:41,player_id:'P041',player_name:'Dinesh j suthar'},{id:42,player_id:'P042',player_name:'Raj singh'},
  {id:43,player_id:'P043',player_name:'Vadant kabra'},{id:44,player_id:'P044',player_name:'Jeevan Gunjal'},
  {id:45,player_id:'P045',player_name:'Deepak Yadav'},{id:46,player_id:'P046',player_name:'Deep Dama'},
  {id:47,player_id:'P047',player_name:'Kalash Porwal'},{id:48,player_id:'P048',player_name:'AARUSH GUPTA BADA'},
  {id:49,player_id:'P049',player_name:'Jimit'},{id:50,player_id:'P050',player_name:'deepak dama'},
  {id:51,player_id:'P051',player_name:'manoj mishra'},{id:52,player_id:'P052',player_name:'Veer'},
  {id:53,player_id:'P053',player_name:'Yuvraj Singh'},{id:54,player_id:'P054',player_name:'Rishi Devadiga'},
  {id:55,player_id:'P055',player_name:'Kailash Jain'},{id:56,player_id:'P056',player_name:'Arpit ashish pandey'},
  {id:57,player_id:'P057',player_name:'Rudhra Dev Jetli'},{id:58,player_id:'P058',player_name:'Meet Dama'},
  {id:59,player_id:'P059',player_name:'Sahil rastogi'},{id:60,player_id:'P060',player_name:'Rounik singh'},
  {id:61,player_id:'P061',player_name:'Anuj Doshi'},{id:62,player_id:'P062',player_name:'Vansh suryawanshi'},
  {id:63,player_id:'P063',player_name:'Nikhil Waghela'},{id:64,player_id:'P064',player_name:'diinesh suthar'},
  {id:65,player_id:'P065',player_name:'vivek mehra'},{id:66,player_id:'P066',player_name:'jimmy mehta'},
  {id:67,player_id:'P067',player_name:'jighnesh mehta'},{id:68,player_id:'P068',player_name:'nilesh sharma'},
  {id:69,player_id:'P069',player_name:'prakash kadam'}
];
